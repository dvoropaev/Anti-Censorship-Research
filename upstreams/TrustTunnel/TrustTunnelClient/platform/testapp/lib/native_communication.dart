...
class NativeVpnInterface {
  /// Constructor for [NativeVpnInterface].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  NativeVpnInterface({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<void> stop() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.com_adguard_testapp.NativeVpnInterface.stop$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
abstract class FlutterCallbacks {
  ...
  static void setUp(FlutterCallbacks? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.com_adguard_testapp.FlutterCallbacks.onStateChanged$messageChannelSuffix', pigeonChannelCodec,
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.com_adguard_testapp.FlutterCallbacks.onStateChanged was null.');
